...
constexpr PointsMaps::PointsMaps(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : stops_()
  , companies_(){}
struct PointsMapsDefaultTypeInternal {
  constexpr PointsMapsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~PointsMapsDefaultTypeInternal() {}
  union {
    PointsMaps _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PointsMapsDefaultTypeInternal _PointsMaps_default_instance_;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_map_5frenderer_2eproto[5];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_map_5frenderer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::TCProto::PointsMaps, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::TCProto::PointsMaps, stops_),
  PROTOBUF_FIELD_OFFSET(::TCProto::PointsMaps, companies_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::TCProto::MapRenderer, points_maps_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 28, -1, sizeof(::TCProto::PointsMaps)},
  { 35, -1, sizeof(::TCProto::BusColor)},
  { 42, -1, sizeof(::TCProto::MapRenderer)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::TCProto::_PointsMaps_default_instance_),
...
const char descriptor_table_protodef_map_5frenderer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".SvgProto.Point\"T\n\nPointsMaps\022\"\n\005stops\030\001"
  " \003(\0132\023.TCProto.StopCoords\022\"\n\tcompanies\030\002"
  " \003(\0132\017.SvgProto.Point\"8\n\010BusColor\022\014\n\004nam"
  "e\030\001 \001(\t\022\036\n\005color\030\002 \001(\0132\017.SvgProto.Color\""
  "\303\001\n\013MapRenderer\0220\n\017render_settings\030\001 \001(\013"
  "2\027.TCProto.RenderSettings\022(\n\013points_maps"
  "\030\002 \001(\0132\023.TCProto.PointsMaps\022%\n\nbus_color"
  "s\030\003 \003(\0132\021.TCProto.BusColor\0221\n\020bus_descri"
  "ptions\030\004 \003(\0132\027.TCProto.BusDescriptionb\006p"
  "roto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_map_5frenderer_2eproto = {
  false, false, 925, descriptor_table_protodef_map_5frenderer_2eproto, "map_renderer.proto", 
  &descriptor_table_map_5frenderer_2eproto_once, descriptor_table_map_5frenderer_2eproto_deps, 2, 5,
...
class PointsMaps::_Internal {
 public:
};

void PointsMaps::clear_companies() {
  companies_.Clear();
}
PointsMaps::PointsMaps(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  stops_(arena),
  companies_(arena) {
  ...
  // @@protoc_insertion_point(arena_constructor:TCProto.PointsMaps)
}
PointsMaps::PointsMaps(const PointsMaps& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      stops_(from.stops_),
      companies_(from.companies_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:TCProto.PointsMaps)
}

inline void PointsMaps::SharedCtor() {
}

PointsMaps::~PointsMaps() {
  // @@protoc_insertion_point(destructor:TCProto.PointsMaps)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void PointsMaps::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void PointsMaps::ArenaDtor(void* object) {
  PointsMaps* _this = reinterpret_cast< PointsMaps* >(object);
  (void)_this;
}
void PointsMaps::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void PointsMaps::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void PointsMaps::Clear() {
// @@protoc_insertion_point(message_clear_start:TCProto.PointsMaps)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* PointsMaps::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* PointsMaps::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:TCProto.PointsMaps)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:TCProto.PointsMaps)
  return target;
}

size_t PointsMaps::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:TCProto.PointsMaps)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData PointsMaps::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    PointsMaps::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*PointsMaps::GetClassData() const { return &_class_data_; }

void PointsMaps::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<PointsMaps *>(to)->MergeFrom(
      static_cast<const PointsMaps &>(from));
}


void PointsMaps::MergeFrom(const PointsMaps& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:TCProto.PointsMaps)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void PointsMaps::CopyFrom(const PointsMaps& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:TCProto.PointsMaps)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool PointsMaps::IsInitialized() const {
  return true;
}

void PointsMaps::InternalSwap(PointsMaps* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata PointsMaps::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_map_5frenderer_2eproto_getter, &descriptor_table_map_5frenderer_2eproto_once,
...
class MapRenderer::_Internal {
 public:
  ...
  static const ::TCProto::PointsMaps& points_maps(const MapRenderer* msg);
};
...
const ::TCProto::PointsMaps&
MapRenderer::_Internal::points_maps(const MapRenderer* msg) {
  return *msg->points_maps_;
}
...
MapRenderer::MapRenderer(const MapRenderer& from)
  ...
  if (from._internal_has_points_maps()) {
    points_maps_ = new ::TCProto::PointsMaps(*from.points_maps_);
  } else {
    points_maps_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&points_maps_) -
    reinterpret_cast<char*>(&render_settings_)) + sizeof(points_maps_));
}
...
inline void MapRenderer::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete points_maps_;
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_points_maps(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* MapRenderer::_InternalSerialize(
  ...
  // .TCProto.PointsMaps points_maps = 2;
  if (this->_internal_has_points_maps()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        2, _Internal::points_maps(this), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:TCProto.MapRenderer)
  ...
  if (from._internal_has_points_maps()) {
    _internal_mutable_points_maps()->::TCProto::PointsMaps::MergeFrom(from._internal_points_maps());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void MapRenderer::InternalSwap(MapRenderer* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MapRenderer, points_maps_)
      + sizeof(MapRenderer::points_maps_)
      - PROTOBUF_FIELD_OFFSET(MapRenderer, render_settings_)>(
...
template<> PROTOBUF_NOINLINE ::TCProto::PointsMaps* Arena::CreateMaybeMessage< ::TCProto::PointsMaps >(Arena* arena) {
  return Arena::CreateMessageInternal< ::TCProto::PointsMaps >(arena);
}
