...
const char descriptor_table_protodef_descriptions_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022descriptions.proto\022\007TCProto\"@\n\016BusDesc"
  "ription\022\014\n\004name\030\001 \001(\t\022\r\n\005stops\030\002 \003(\t\022\021\n\t"
  "endpoints\030\003 \003(\tb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_descriptions_2eproto = {
  false, false, 103, descriptor_table_protodef_descriptions_2eproto, "descriptions.proto", 
  &descriptor_table_descriptions_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_descriptions_2eproto::offsets,
  file_level_metadata_descriptions_2eproto, file_level_enum_descriptors_descriptions_2eproto, file_level_service_descriptors_descriptions_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_descriptions_2eproto_getter() {
  return &descriptor_table_descriptions_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_descriptions_2eproto(&descriptor_table_descriptions_2eproto);
namespace TCProto {
...
::PROTOBUF_NAMESPACE_ID::Metadata BusDescription::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_descriptions_2eproto_getter, &descriptor_table_descriptions_2eproto_once,
      file_level_metadata_descriptions_2eproto[0]);
}
