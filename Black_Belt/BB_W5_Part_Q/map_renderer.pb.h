...
class MapRenderer final :
 ...
 public:
  ...
  ::TCProto::StopCoords* mutable_stops_coords(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::TCProto::StopCoords >*
      mutable_stops_coords();
  private:
  const ::TCProto::StopCoords& _internal_stops_coords(int index) const;
  ::TCProto::StopCoords* _internal_add_stops_coords();
  public:
  const ::TCProto::StopCoords& stops_coords(int index) const;
  ::TCProto::StopCoords* add_stops_coords();
...
inline ::TCProto::StopCoords* MapRenderer::mutable_stops_coords(int index) {
  // @@protoc_insertion_point(field_mutable:TCProto.MapRenderer.stops_coords)
  return stops_coords_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::TCProto::StopCoords >*
MapRenderer::mutable_stops_coords() {
  // @@protoc_insertion_point(field_mutable_list:TCProto.MapRenderer.stops_coords)
  return &stops_coords_;
}
inline const ::TCProto::StopCoords& MapRenderer::_internal_stops_coords(int index) const {
  return stops_coords_.Get(index);
}
inline const ::TCProto::StopCoords& MapRenderer::stops_coords(int index) const {
  // @@protoc_insertion_point(field_get:TCProto.MapRenderer.stops_coords)
  return _internal_stops_coords(index);
}
inline ::TCProto::StopCoords* MapRenderer::_internal_add_stops_coords() {
  return stops_coords_.Add();
}
inline ::TCProto::StopCoords* MapRenderer::add_stops_coords() {
  ::TCProto::StopCoords* _add = _internal_add_stops_coords();
  // @@protoc_insertion_point(field_add:TCProto.MapRenderer.stops_coords)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::TCProto::StopCoords >&
MapRenderer::stops_coords() const {
  // @@protoc_insertion_point(field_list:TCProto.MapRenderer.stops_coords)
  return stops_coords_;
}
